    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div>
            <h2 style={{ color: '#fff', fontWeight: 800, fontSize: '20px', margin: 0 }}>Edit Product</h2>
            <p style={{ color: 'rgba(255,255,255,0.4)', fontSize: '13px', margin: '4px 0 0' }}>Update product details</p>
          </div>
          <button
            onClick={onClose}
            style={{
          ...
          <div>
            ...
            <label htmlFor='uploadImageInput' style={{ cursor: uploading ? 'wait' : 'pointer' }}>
              ...
              >
                ...
                <input type='file' id='uploadImageInput' onChange={handleUploadProduct} style={{ display: 'none' }} />
              </div>
            </label>
